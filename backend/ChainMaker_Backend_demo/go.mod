module ChainMaker_Backend_demo
...
require (
	chainmaker.org/chainmaker/common/v3 v3.0.0 // indirect
	chainmaker.org/chainmaker/pb-go/v3 v3.0.0 // indirect
	chainmaker.org/chainmaker/protocol/v3 v3.0.0 // indirect
	chainmaker.org/chainmaker/sdk-go/v3 v3.0.0 // indirect
	chainmaker.org/chainmaker/utils/v3 v3.0.0 // indirect
