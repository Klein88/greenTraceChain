...
let idnew=0;
onMounted(async () => {
  tableData.value = await axios.post('http://47.97.176.174:8087/chainmaker?cmb=GetTransactionDataByCompanyId', {CompanyId :ID.value })
      ...
      <el-card shadow="never">
        ...
        <div class="main-middle">
          <el-table :data="tableData.slice((currentPage - 1) * pageSize, currentPage * pageSize)" border style="width: 100%" table-layout="auto" :header-cell-style="{ background:'#f4f4f5' }">
            <el-table-column label="ID" align="center">{{idnew++}}</el-table-column>
