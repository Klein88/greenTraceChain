...
const onSubmitRegister = async () => {
  try {
    const response = await axios.post('http://47.97.176.174:8087/chainmaker?cmb=DAPRegisiter', {
      CompanyID: registerData.username,
  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
        ...
        <form @submit.prevent="onSubmitRegister" class="sign-up-form">
